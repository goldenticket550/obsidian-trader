...
Feed: `sip`. WAKING gate calibration found no acceptable fit; active gate values remain unchanged. Rows are ordered by attention velocity in WAKING UP and attention score in IN PLAY. State is membership metadata.
